...
// pc复位值
`define RESET_PC_VALUE          32'h0040_0000 //重置地址
// `define RESET_PC_VALUE          32'h0000_0000 //重置地址
...
`define INST_TYPE_R  `OPCODE_WIDTH'b0110011 // add/sub/xor/or/and/sll/srl/sra/slt/sltu/mul/mulh/mulhsu/mulhu/div/divu/rem/remu
...
// R-type mul/mulh/mulhsu/mulhu/div/divu/rem/remu
...
`define ALU_NONE         `ALU_OP_WIDTH'b11111 // illegal operation
...
`define ALU_MUL          `ALU_OP_WIDTH'b10001 // mul
`define ALU_MULH         `ALU_OP_WIDTH'b10010 // mulh
`define ALU_MULHSU       `ALU_OP_WIDTH'b10011 // mulhsu
`define ALU_MULHU        `ALU_OP_WIDTH'b10100 // mulhu
`define ALU_DIV          `ALU_OP_WIDTH'b10101 // div
`define ALU_DIVU         `ALU_OP_WIDTH'b10110 // divu
`define ALU_REM          `ALU_OP_WIDTH'b10111 // rem
`define ALU_REMU         `ALU_OP_WIDTH'b11000 // remu
...
`define MEM_ACCESS_TYPE_READ_BYTE   `MEM_ACCESS_TYPE_WIDTH'b001 //1
`define MEM_ACCESS_TYPE_READ_HALF   `MEM_ACCESS_TYPE_WIDTH'b010 //2
`define MEM_ACCESS_TYPE_READ_WORD   `MEM_ACCESS_TYPE_WIDTH'b011 //3

`define MEM_ACCESS_TYPE_WRITE_BYTE  `MEM_ACCESS_TYPE_WIDTH'b100 //4
`define MEM_ACCESS_TYPE_WRITE_HALF  `MEM_ACCESS_TYPE_WIDTH'b101 //5
`define MEM_ACCESS_TYPE_WRITE_WORD  `MEM_ACCESS_TYPE_WIDTH'b110 //6