...
//STATE input
`define STATE_WIDTH             2       //状态机输入宽度
`define STATE_RESET     `STATE_WIDTH'b00
`define STATE_DOWNLOAD  `STATE_WIDTH'b01
`define STATE_RUN       `STATE_WIDTH'b10
`define STATE_ERROR     `STATE_WIDTH'b11
...
`define MEM_ADDR_DEPTH  `INST_MEM_ADDR_DEPTH + `DATA_MEM_ADDR_DEPTH
...
//MEM ACCESS opcode
`define MEM_ACCESS_TYPE_WIDTH 2
`define MEM_ACCESS_TYPE_NONE  `MEM_ACCESS_TYPE_WIDTH'b00
`define MEM_ACCESS_TYPE_READ  `MEM_ACCESS_TYPE_WIDTH'b01
`define MEM_ACCESS_TYPE_WRITE `MEM_ACCESS_TYPE_WIDTH'b10


//MEM ACCESS size
`define MEM_ACCESS_SIZE_WIDTH 3
`define MEM_ACCESS_SIZE_NONE  `MEM_ACCESS_SIZE_WIDTH'b000
`define MEM_ACCESS_SIZE_BYTE  `MEM_ACCESS_SIZE_WIDTH'b001
`define MEM_ACCESS_SIZE_HALF  `MEM_ACCESS_SIZE_WIDTH'b010
`define MEM_ACCESS_SIZE_WORD  `MEM_ACCESS_SIZE_WIDTH'b011
